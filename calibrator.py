...
class RectangleDetector(Calibrator):
        ...
        for cnt in contours:
            if cv.contourArea(cnt) > 250: # adjust threshold if needed
                ...
                if len(approx) == 4:
                    ...
                    self.calibrator.center_point = self.get_center_point(rect)
    ...
    def draw_center_point(self, frame):
        ...
        center = self.calibrator.center_point
...
class QRCodeDetector(Calibrator):
    ...
    def find_cal_ref(self, frame:np.ndarray):
        ...
        self.calibrator_info.center_point = center_point
    ...
    def draw_boundary_and_center(self, frame):
        ...
        center = self.calibrator_info.center_point
        cv.circle(frame, center, 5, (0,255,0), -1)
